...
public class WorkshopMessages
{
    ...
    public static string WorkshopAlreadyExists = "Bu çalışma zaten kullanımda!";
    public static string WorkshopsAlreadyExists = "Bu çalışma mevcut!";
    public static string WorkshopUpdatedSuccessfully = "Çalışma başarıyla güncellendi!";
    public static string WorkshopDeletedSuccessfully = "Çalışma başarıyla silindi!";
}