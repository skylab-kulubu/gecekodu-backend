package com.example.gecekodubackend.business.constants;
...
public class EventMessages {
    ...
    public static String eventAlreadyExists = "Bu tarihte bir etkinlik zaten var!";
    ...
    public static String eventCouldNotBeAdded = "Etkinlik eklenemedi!";
    public static String eventCouldNotBeUpdated = "Etkinlik güncellenemedi!";
}
